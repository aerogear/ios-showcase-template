...
class AccessControlViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    static let accessControlStoryBoard = UIStoryboard(name: "accesscontrol", bundle: nil)
    ...
    override func viewDidLoad() {
        ...
        userIdentity = try! AgsAuth.instance.currentUser()
    }
    ...
    */
    ...
    static func loadViewController() -> UIViewController {
        return accessControlStoryBoard.instantiateViewController(withIdentifier: "AccessControlViewController")
    }
}
