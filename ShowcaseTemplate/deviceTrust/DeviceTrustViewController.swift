...
class DeviceTrustViewController: UITableViewController {
    static let deviceTrustStoryBoard = UIStoryboard(name: "deviceTrust", bundle: nil)
    ...
    override func viewDidLoad() {
        ...
        deviceTrustService = iosDeviceTrustService()
    ...
    func performTrustChecks() {
        if let service = self.deviceTrustService {
            self.deviceChecks = service.performTrustChecks()
    ...
    static func loadViewController() -> UIViewController {
        return deviceTrustStoryBoard.instantiateViewController(withIdentifier: "DeviceTrustViewController")
    }
}
